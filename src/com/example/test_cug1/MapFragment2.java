...
public class MapFragment2 extends Fragment{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		myMainView=inflater.inflate(R.layout.mapfragment2, 
				(ViewGroup)getActivity().findViewById(R.id.map_view_pager), false);
		WindowManager manager = getActivity().getWindowManager();
		window_width = manager.getDefaultDisplay().getWidth();
		window_height = manager.getDefaultDisplay().getHeight();

		dragImageView = (DragImageView) myMainView.findViewById(R.id.school_map);
		Bitmap bmp = BitmapUtil.ReadBitmapById(getActivity(), R.drawable.mapfragment,

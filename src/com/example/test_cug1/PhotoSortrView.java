...
import com.example.test_cug1.MultiTouchController.MultiTouchObjectCanvas;
import com.example.test_cug1.MultiTouchController.PointInfo;
import com.example.test_cug1.MultiTouchController.PositionAndScale;
...
public class PhotoSortrView extends View implements MultiTouchObjectCanvas<PhotoSortrView.Img>{
	private static final int[] IMAGES = { R.drawable.west1,
		R.drawable.west2, R.drawable.west3, R.drawable.west4 };
